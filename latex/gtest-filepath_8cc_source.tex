...
\DoxyCodeLine{00132\ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classtesting_1_1internal_1_1String_a968f242b709f8c7c0ed5ecf246553321}{String::EndsWithCaseInsensitive}}(pathname\_,\ dot\_extension))\ \{}
...
\DoxyCodeLine{00156\ \ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}\ =\ pathname\_;}
\DoxyCodeLine{00157\ \ \ \textcolor{keyword}{auto}\ s\ =\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}.begin();}
\DoxyCodeLine{00158\ \ \ \textcolor{keyword}{auto}\ end\ =\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}.end();}
...
\DoxyCodeLine{00190\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(s\ -\/\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}.begin());}
\DoxyCodeLine{00191\ \}}
\DoxyCodeLine{00192\ }
...
\DoxyCodeLine{00270\ \ \ \textcolor{keyword}{const}\ FilePath\&\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}(IsRootDirectory()\ ?\ *\textcolor{keyword}{this}}
\DoxyCodeLine{00271\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ RemoveTrailingPathSeparator());}
\DoxyCodeLine{00272\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00273\ \ \ \textcolor{keyword}{const}\ FilePath\&\ \mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}(*\textcolor{keyword}{this});}
\DoxyCodeLine{00274\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00275\ }
\DoxyCodeLine{00276\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS\_MOBILE}}
\DoxyCodeLine{00277\ \ \ LPCWSTR\ unicode\ =\ String::AnsiToUtf16(\mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}.c\_str());}
...
\DoxyCodeLine{00287\ \ \ \ \ \ \ posix::Stat(\mbox{\hyperlink{idl__gen__ts_8cpp_a4d455efceee21e97d8e21ee40e9b4a20}{path}}.c\_str(),\ \&file\_stat)\ ==\ 0\ \&\&\ posix::IsDir(file\_stat);}
