...
\doxysection*{Generic Comparison}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.

\doxysection*{Container Matchers}
...
\doxysection*{Matching the Result of a Function, Functor, or Callback}
...
\doxysection*{Composite Matchers}
...
\doxysection*{Adapters for Matchers}
