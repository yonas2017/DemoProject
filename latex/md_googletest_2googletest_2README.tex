...
\doxysubsection*{Build with CMake}
...
\doxysubsubsection*{Standalone CMake Project}
...
\doxysubsubsection*{Incorporating Into An Existing CMake Project}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.

\doxyparagraph*{Visual Studio Dynamic vs Static Runtimes}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/main/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.

\doxysubsection*{Multi-\/threaded Tests}
...
\doxysubsection*{As a Shared Library (DLL)}
...
\doxysubsection*{Avoiding Macro Name Clashes}
