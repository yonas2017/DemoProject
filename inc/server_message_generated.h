...
struct server_message_t FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    uint8_t job_info() const { return GetField<uint8_t>(VT_JOB_INFO, 0); }
    bool    mutate_job_info(uint8_t _job_info = 0)
    {
        return SetField<uint8_t>(VT_JOB_INFO, _job_info, 0);
    }
    uint32_t job_text_length() const
    {
        return GetField<uint32_t>(VT_JOB_TEXT_LENGTH, 0);
    }
    bool mutate_job_text_length(uint32_t _job_text_length = 0)
    {
        return SetField<uint32_t>(VT_JOB_TEXT_LENGTH, _job_text_length, 0);
    }
    const ::flatbuffers::Vector<int8_t> *job_tekst() const
    {
        return GetPointer<const ::flatbuffers::Vector<int8_t> *>(VT_JOB_TEKST);
    }
    ::flatbuffers::Vector<int8_t> *mutable_job_tekst()
    {
        return GetPointer<::flatbuffers::Vector<int8_t> *>(VT_JOB_TEKST);
    }
    bool Verify(::flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) &&
               ...
               verifier.VerifyVector(job_tekst()) && verifier.EndTable();
    }
};
...
struct server_message_tBuilder
{
    ...
    {
        fbb_.AddElement<uint32_t>(server_message_t::VT_JOB_TEXT_LENGTH,
                                  job_text_length, 0);
    }
    void add_job_tekst(
        ::flatbuffers::Offset<::flatbuffers::Vector<int8_t>> job_tekst)
    {
...
inline ::flatbuffers::Offset<server_message_t> Createserver_message_t(
    ::flatbuffers::FlatBufferBuilder &_fbb, uint8_t job_info = 0,
    ...
    const std::vector<int8_t> *job_tekst = nullptr)
{
    ...
    return Createserver_message_t(_fbb, job_info, job_text_length, job_tekst__);
}
...
inline server_message_t *GetMutableserver_message_t(void *buf)
{
    return ::flatbuffers::GetMutableRoot<server_message_t>(buf);
}

inline server_message_t *GetMutableSizePrefixedserver_message_t(void *buf)
{
    return ::flatbuffers::GetMutableSizePrefixedRoot<server_message_t>(buf);
}

inline bool Verifyserver_message_tBuffer(::flatbuffers::Verifier &verifier)
{
