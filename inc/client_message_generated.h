...
struct client_message_t FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  ClientMessageType msg_type() const {
    return static_cast<ClientMessageType>(GetField<uint8_t>(VT_MSG_TYPE, 0));
  }
  bool mutate_msg_type(ClientMessageType _msg_type = static_cast<ClientMessageType>(0)) {
    return SetField<uint8_t>(VT_MSG_TYPE, static_cast<uint8_t>(_msg_type), 0);
  }
  bool all_jobs() const {
    return GetField<uint8_t>(VT_ALL_JOBS, 0) != 0;
  }
  bool mutate_all_jobs(bool _all_jobs = 0) {
    return SetField<uint8_t>(VT_ALL_JOBS, static_cast<uint8_t>(_all_jobs), 0);
  }
  uint16_t num_jobs() const {
    return GetField<uint16_t>(VT_NUM_JOBS, 0);
  }
...
struct client_message_tBuilder {
  ...
  void add_msg_type(ClientMessageType msg_type) {
    fbb_.AddElement<uint8_t>(client_message_t::VT_MSG_TYPE, static_cast<uint8_t>(msg_type), 0);
  }
  void add_all_jobs(bool all_jobs) {
    fbb_.AddElement<uint8_t>(client_message_t::VT_ALL_JOBS, static_cast<uint8_t>(all_jobs), 0);
  }
...
inline ::flatbuffers::Offset<client_message_t> Createclient_message_t(
    ...
    ClientMessageType msg_type = GET_JOB,
    bool all_jobs = false,
    uint16_t num_jobs = 0) {
...
inline bool Verifyclient_message_tBuffer(
